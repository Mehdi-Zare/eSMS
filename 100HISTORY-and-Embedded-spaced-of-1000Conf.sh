...
#                                                               Author: Mehdi Zare                                                                         #
#                                                                                                                                                          #
#               Purpose : It gets 100 water conformation of your 1000-HISTORY file equally speced and convert it to embedded file for PEECM                #
#                         Calculations. It needs head.embedded, mid.embedded an ConfigTypeEmbeddedHead files in your current                               #
#                         directory as well as HISTORY file in the above directory. It used 1000-HISTRY file that you have in your each Bin                #
