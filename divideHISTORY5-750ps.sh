...
#                                                               Author: Mehdi Zare                                                                         #
#                                                                                                                                                          #
#               Purpose : It divides the History file which contains 14,500 (725 ps sampling) water conformations to 5 HISTORY                             #
#                 files each contains 2000 conformations.we use here the first 10000 water conformations not the whole of				   #
#		    14500 conformations All your HISTORY files are named HISTORY.1 to HISTORY.5 in histories directory                                     #
...
sed -i "s/14500/2000/" head.HISTORY          				 # Modifying number of conformations in header
